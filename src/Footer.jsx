...
function Footer() {
  ...
  return (
    <ComponentWrapper
      ...
      <div>
        <div className="flex-col md:flex-row flex gap-4 items-center justify-between">
          <div className="md:w-3/12">
            <img src={logo} alt="Logo" className="h-[82px] w-[196.81px]" />
          </div>
          <div className="w-full md:w-9/12 flex-col gap-6 flex md:flex-row items-center justify-start">
